...
\tcbset{
  bluebox/.style={colback=blue!10, colframe=blue!50!black, left=2pt, right=2pt, top=1pt, bottom=1pt, width=0.95\columnwidth, boxrule=0.5mm, arc=0mm, before skip=0pt, after skip=0pt},
  redbox/.style={colback=red!10, colframe=red!50!black, left=2pt, right=2pt, top=1pt, bottom=1pt, width=0.95\columnwidth, boxrule=0.5mm, arc=0mm, before skip=0pt, after skip=0pt},
  greenbox/.style={colback=green!10, colframe=green!50!black, left=2pt, right=2pt, top=1pt, bottom=1pt, width=0.95\columnwidth, boxrule=0.5mm, arc=0mm, before skip=0pt, after skip=0pt}
}

% Much more aggressive spacing reduction
...
\linespread{0.9}  % Reduce line spacing throughout document

% For section and subsection spacing
\usepackage{titlesec}
